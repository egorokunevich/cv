  ...
  return (
    ...
    >
      <div className="flex flex-col">
        ...
        <div className="w-full text-4xl max-lg:text-2xl max-xsm:text-xl font-extralight flex justify-start p-4 max-xsm:p-2 max-xxsm:p-1 max-xxsm:pt-0 pt-0 duration-200">
